...
public class DiarcExp extends DistributedExperiment {
	public static final ILogger						LOG	= LoggerFactory
																.create(DiarcExp.class);

	private final LogicalExpressionCategoryServices	categoryServices;

	public DiarcExp(File initFile) throws IOException {
		this(initFile, Collections.<String, String> emptyMap(),
				new DiarcResourceRepo());
	}

	public DiarcExp(File initFile, Map<String, String> envParams,
	...
	System.out.println("why arent you ending");
		// //////////////////////////////////////////
